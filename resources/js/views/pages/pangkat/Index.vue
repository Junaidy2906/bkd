...
<div class="animated fadeIn">
  <b-card>
    ...
    <app-datatable v-if="fields" :editUrl="'/pangkat-golongan/'" :deleteData="deleteRow" :isBusy="isBusy" :items="items" :fields="fields" :meta="meta" @per_page="handlePerPage" @pagination="handlePagination" @search="handleSearch" @sort="handleSort" />
...
export default {
    ...
    methods: {
        ...
        prosesDelete(id) {
            ...
            axios.delete('/api/pangkat-golongan/' + id).then((response) => {
                this.$swal({
        ...
        loadPostsData() {
            ...
            axios.get(`/api/pangkat-golongan`, {
